...
def _print_text(report: dict) -> None:
    console = Console()
    console.print(f"[bold]Halifax criteria result:[/bold] {report['overall_result']}")
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Evaluate a case against Halifax lending criteria.")
